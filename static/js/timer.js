...
function study_timer() {
	...
	else if (date.getHours() < 10 || date.getHours() < 11 & date.getMinutes() < 45) {
	...
	else if (date.getHours() < 14 || date.getHours() < 15 & date.getMinutes() < 30) {
		var endDate = new Date(2020, month, clockDate, 14, 30, 00); // 종료날짜
		study = false;
	}
	else if (date.getHours() < 15 || date.getHours() < 16 & date.getMinutes() < 45) {
